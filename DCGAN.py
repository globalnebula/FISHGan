...
samples_path = "data\\training_set\\species_samples"
output_images_path = "gen"
    ...
    def __init__(self, images_path, transform=None):
        ...
        if corrupted_files:
            ...
            if len(corrupted_files) < 10:
                ...
                print("First 10 corrupted files:", corrupted_files[:10])
...
if len(dataset) == 0:
    print("Error: No valid images found in the dataset. Please check your data folder.")
    import sys
    sys.exit(1)
